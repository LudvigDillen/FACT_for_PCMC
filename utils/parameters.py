...
class Params:
    def __init__(self, nusc, args, pointwise=True):
        ...
        )  # (int): The factor to downsample the scenes with.
        ...
        assert args.fps.num_point % 2 == 0, "args.num_point must be even"
        self.N_fps_points = int(args.fps.num_point / 2)
