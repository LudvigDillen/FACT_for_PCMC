...
def perform_coral_training(X_train, y_train, X_val, y_val, logger, epochs=10_000, learning_rate=0.03):
    # TRANING
...
def perform_coral_inference(X_test, y_test, model):
    accuracy_test, predicted_test = perform_logistic_regression_inference(X_test, y_test, model)
